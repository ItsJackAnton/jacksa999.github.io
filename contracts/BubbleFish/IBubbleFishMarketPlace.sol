 ...
 */
interface IBubbleFishMarketPlace {
    ...
    * Requirement: Only the contract owner can call.
     */
    function setBubbleFishContract(address _kittyContractAddress) external;
    ...
    * Requirement: There must be an active offer for _tokenId
     */
    function buyBubbleFish(uint256 _tokenId) external payable;
}
